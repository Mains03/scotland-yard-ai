...
import uk.ac.bris.cs.scotlandyard.ui.ai.minimumDistanceStrategy.MemoizedMinimumDistanceStrategyProxy;
...
public class MyAi implements Ai {
	...
	@Nonnull @Override public Move pickMove(
		...
		return determineBestMove(new MemoizedMinimumDistanceStrategyProxy(board));
	}
